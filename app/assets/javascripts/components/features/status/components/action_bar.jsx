  ...
  render () {
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        <div style={{ flex: '1 1 auto', textAlign: 'center' }}><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' onClick={this.handleFavouriteClick} activeStyle={{ color: '#EBDC98' }} /></div>
